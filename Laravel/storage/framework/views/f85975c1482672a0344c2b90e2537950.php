...
<body>
    ...
    <nav class="top-bar d-flex justify-content-between border-bottom border-dark align-items-center px-3">
        <div class="d-flex align-items-center">
            <a  class="nav-link <?php echo e(request()->routeIs('diabolo.profile') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.profile')); ?>"><i class="fas fa-home me-1"></i>Diabolo</a>
    ...
    <div class="sidebar border-end border-dark">
        <nav class="nav flex-column">
            ...
            <a class="nav-link nav-link <?php echo e(request()->routeIs('diabolo.market') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.market')); ?>" href="#"><i class="fas fa-store"></i> <span>Marketplace</span></a>
            <a class="nav-link nav-link nav-link <?php echo e(request()->routeIs('diabolo.work') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.work')); ?>" href="#"><i class="fas fa-briefcase"></i> <span>Trabajo</span></a>
            <a class="nav-link <?php echo e(request()->routeIs('diabolo.posts') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.posts')); ?>"><i class="fas fa-newspaper"></i> <span>Posts</span></a>
            <a class="nav-link <?php echo e(request()->routeIs('diabolo.comments') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.comments')); ?>" href="#"><i class="fas fa-comment"></i> <span>Comentarios</span></a>
            <!--ANALÍTICAS-->
            <div class="sidebar-divider"></div>
            <a class=nav-link <?php echo e(request()->routeIs('diabolo.analiticas') ? 'active' : ''); ?>" href="<?php echo e(route('diabolo.analiticas')); ?>" href="#"><i class="fas fa-chart-bar"></i> <span>Analíticas</span></a>
            <div class="sidebar-divider"></div>
            <!--CONFIGURACIÓN-->
