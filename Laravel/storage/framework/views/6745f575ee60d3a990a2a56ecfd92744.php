...
<div class="w-full h-screen">
  <div class="w-full rounded-lg bg-white shadow-lg p-4">
    <h1 class="text-lg text-[var(--negro)] font-bold mb-3">Posts</h1>
    <div class="w-full">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/diabolo/posts.blade.php ENDPATH**/ ?>